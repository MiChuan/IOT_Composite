#ifndef LIBARY_TABLEMODEL_H
#define LIBARY_TABLEMODEL_H
...
class Libary_TableModel : public QSqlTableModel
{
    Q_OBJECT
private:
...
public:
    explicit Libary_TableModel(QObject *parent = 0);
